            ...
            {subscriptionPlans.map((plan, idx) => {
              ...
              return (
                  ...
                  >
                    ...
                    {plan.popular && (
                      <div className={`absolute -top-3 left-1/2 -translate-x-1/2 text-[10px] font-black px-4 py-1 rounded-full uppercase tracking-widest shadow-lg z-20 ${tierType === 'ULTRA' ? 'bg-yellow-400 text-black' : 'bg-cyan-500 text-white'}`}>
                        Most Popular
                      </div>
                    )}
                    ...
                    <button
                      ...
                      className={`w-full py-3 px-4 rounded-xl font-bold flex items-center justify-center gap-2 transition-all relative z-10 ${
                        tierType === 'ULTRA'
                          ? 'bg-yellow-400 text-black hover:bg-yellow-300 hover:shadow-lg hover:-translate-y-1'
                          : 'bg-cyan-500 text-white hover:bg-cyan-600'
                      }`}
                    >
                      {tierType === 'ULTRA' ? <Crown size={18} /> : <ShoppingBag size={18} />}
