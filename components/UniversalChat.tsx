...
import { Send, Trash2, Edit2, Shield, User as UserIcon, Lock, Clock, Coins, Crown, MessageCircle, AlertTriangle, Ban, ArrowLeft, Globe, ToggleRight, ToggleLeft } from 'lucide-react';
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-slate-50">
            {messages.map((msg) => {
                ...
                return (
                 ...
                 {/* PRIVACY CHANGE: Only show User ID, hide Name/Email */}
